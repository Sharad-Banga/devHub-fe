...
export const S1 = () => {
  return (
    <div className="hidden sm:block">
      <div className="h-[90vh] flex justify-evenly items-center w-full">
        ...
        <div className="text-white absolute font-extrabold flex-col justify-between sm:h-[40vh] text-[25px] md:text-[60px] select-none w-[100] font-dela-gothic text text-nowrap">
